...
- Asset storage is local disk, not object storage (S3/GCS/etc.) — fine for a single-instance demo, would need to move before this could run on multiple app instances or ephemeral containers.
